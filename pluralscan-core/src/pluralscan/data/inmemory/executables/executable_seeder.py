...
class InMemoryExecutableRepositorySeeder:
    ...
    def _add_entities(self):
        ...
        analyzer.add_executable(
            self._executable_repository.find_by_id(ExecutableId("RoslynatorDotnet"))
        )
        ...
        analyzer = self._analyzer_repository.find_by_id(AnalyzerId("Roslynator"))
        analyzer.add_executable(
            self._executable_repository.find_by_id(ExecutableId("RoslynatorFork"))
        )
        ...
        analyzer.add_executable(
            self._executable_repository.find_by_id(ExecutableId("DependencyCheck"))
        )
