...
from .serializers import ProjectListSerializer, ProjectSerializer, PackageSerializer
...
class ProjectViewSet(ListCreateAPIView):
    ...
    def get(self, request: Request, *args, **kwargs):
        ...
        project_serializer = ProjectListSerializer(data=result.projects, many=True)
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            project_serializer: ProjectSerializer = ProjectSerializer(
                data=result.project.to_dict()
            )
            project_serializer.is_valid()

            package_serializer = PackageSerializer(
                data=result.package.to_dict()
            )
    ...
    def find_one(self, _: Request, source=None, name=None):
        ...
        try:
            ...
            serializer: ProjectSerializer = ProjectSerializer(data=result.project)
