...
from cleansecpy.application.usecases.package.new_package_use_case import NewPackageCommand, NewPackageUseCase
from cleansecpy.data import AbstractRepositoryFactory
from cleansecpy.infrastructure.downloader.http import HttpDownloader
...
def new(name: str, url: str, description: str = None):
    ...
    source_service = GithubSourceFetcher(HttpDownloader())
